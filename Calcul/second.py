...
abs_value = Button(tk_calc,
                   button_params,
                   text='abs',
                   command=lambda: button_click('abs(')).grid(row=1,
                                                              column=0,
                                                              sticky="nsew")
...
modulo = Button(tk_calc,
                button_params,
                text='mod',
                command=lambda: button_click('%')).grid(row=1,
                                                        column=1,
                                                        sticky="nsew")
...
pi_num = Button(tk_calc,
                button_params,
                text='π',
                command=lambda: button_click(str(math.pi))).grid(row=2,
                                                                 column=4,
                                                                 sticky="nsew")
...
second_power = Button(tk_calc,
                      button_params,
                      text='x\u00B2',
                      command=lambda: button_click('**2')).grid(row=3,
                                                                column=0,
                                                                sticky="nsew")
...
third_power = Button(tk_calc,
                     button_params,
                     text='x\u00B3',
                     command=lambda: button_click('**3')).grid(row=3,
                                                               column=1,
                                                               sticky="nsew")
...
nth_power = Button(tk_calc,
                   button_params,
                   text='x^n',
                   command=lambda: button_click('**')).grid(row=3,
                                                            column=2,
                                                            sticky="nsew")
...
inv_power = Button(tk_calc,
                   button_params,
                   text='x\u207b\xb9',
                   command=lambda: button_click('**(-1)')).grid(row=3,
                                                                column=3,
                                                                sticky="nsew")
...
tens_powers = Button(tk_calc,
                     ...
                     command=lambda: button_click('10**')).grid(row=3,
                                                                column=4,
                                                                sticky="nsew")
...
log_base10 = Button(tk_calc,
                    ...
                    command=lambda: button_click('log(')).grid(row=4,
                                                               column=3,
                                                               sticky="nsew")
...
log_basee = Button(tk_calc,
                   button_params,
                   text='ln',
                   command=lambda: button_click('ln(')).grid(row=4,
                                                             column=4,
                                                             sticky="nsew")
...
left_par = Button(tk_calc,
                  button_params,
                  text='(',
                  command=lambda: button_click('(')).grid(row=5,
                                                          column=0,
                                                          sticky="nsew")
...
ex = Button(tk_calc,
            button_params,
            text='e^x',
            command=lambda: button_click('e(')).grid(row=5,
                                                     column=4,
                                                     sticky="nsew")
...
delete_one = Button(tk_calc,
                    ...
                    bg='#db701f').grid(row=6, column=3, sticky="nsew")
delete_all = Button(tk_calc,
                    ...
                    bg='#db701f').grid(row=6, column=4, sticky="nsew")
